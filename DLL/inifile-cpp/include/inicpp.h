...
namespace ini
{
    ...
    class IniSectionBase : public tsl::ordered_map<std::string, IniField, Comparator>
    {
    public:
        IniSectionBase()
        {}
    ...
    template<typename Comparator>
    class IniFileBase : public tsl::ordered_map<std::string, IniSectionBase<Comparator>, Comparator>
    {
    private:
        char fieldSep_ = '=';
        char esc_ = '\\';
